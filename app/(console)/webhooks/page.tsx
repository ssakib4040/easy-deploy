...
const endpoints = [
  {
    ...
    events: "deploy.failed, alert.opened",
    status: "Healthy",
  },
  {
    name: "PagerDuty",
    ...
    <>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 text-xs">
                <Badge variant="outline" className="px-3">
                  <Webhook className="mr-1 h-3 w-3" /> {endpoint.status}
                </Badge>
              </div>
      ...
      <section className="mt-4 grid gap-3 md:grid-cols-3">
        <Card className="border-border/70 bg-card/90">
          <CardHeader>
            <CardTitle className="text-sm">
              <Send className="mr-1 inline h-4 w-4" /> Delivery Throughput
            </CardTitle>
          </CardHeader>
        ...
        <Card className="border-border/70 bg-card/90">
          <CardHeader>
            <CardTitle className="text-sm">
              <Clock4 className="mr-1 inline h-4 w-4" /> Retry Queue
            </CardTitle>
          </CardHeader>
          <CardContent className="text-2xl font-semibold">
            43 events
        ...
        <Card className="border-border/70 bg-card/90">
          <CardHeader>
            <CardTitle className="text-sm">
              <RotateCcw className="mr-1 inline h-4 w-4" /> Signature Failures
            </CardTitle>
          </CardHeader>
      ...
      <Card className="mt-4 border-border/70 bg-card/90">
        ...
        <CardContent className="flex flex-wrap gap-2">
          <MockActionDialog
            ...
            entity="webhook retry queue"
            variant="outline"
          />
          <MockActionDialog
            label="Backfill Last 24h"
            entity="webhook delivery history"
          />
        </CardContent>
      </Card>
    </>
