...
const templates = [
  {
    ...
    desc: "SSR app with API routes and background worker profile",
    tag: "Popular",
  },
  {
    name: "Node API + Postgres",
    desc: "Fastify service with managed database wiring",
    tag: "Backend",
  },
  {
    name: "Python Worker",
    desc: "Queue consumer with retries and dead-letter routing",
    tag: "Worker",
  },
  {
    name: "Static Site CDN",
    desc: "Static publish with global edge caching",
    tag: "Static",
  },
];
  ...
  return (
    <>
      ...
      <div className="mt-4 rounded-2xl border border-dashed border-border/80 bg-muted/20 p-4 text-sm text-muted-foreground">
        ...
        <p className="mt-1">
          Describe your architecture and generate a first-pass deployment
          baseline.
        </p>
      </div>
    </>
